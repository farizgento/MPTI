            ...
            <div class="table-responsive table-rounded">
                <table class="table table-bordered table-striped text-center" style="width: 100%;">
                    <thead class="table-heading">
                        <tr>
                            <th class="py-3 align-middle">Track Number</th>
                            <th class="py-3 align-middle">Nama Pelanggan</th>
                            <th class="py-3 align-middle">Perangkat</th>
                            <th class="py-3 align-middle">Tanggal</th>
                            <th class="py-3 align-middle">Status</th>
                            <th class="py-3 align-middle">Aksi</th>
                        </tr>
                    </thead>
